package com.github.thebuildteam.obelisk.blocks.obelisk;
...
public class OBLFenceBlock extends HorizontalConnectingBlock {
    private final VoxelShape[] cullingShapes;

    public OBLFenceBlock(Settings settings) {
    ...
    public BlockState getStateForNeighborUpdate(BlockState state, Direction direction, BlockState newState, WorldAccess world, BlockPos pos, BlockPos posFrom) {
        ...
        return direction.getAxis().getType() == Type.HORIZONTAL ? (BlockState)state.with((Property)FACING_PROPERTIES.get(direction), this.canConnect(newState, newState.isSideSolidFullSquare(world, posFrom, direction.getOpposite()), direction.getOpposite())) : super.getStateForNeighborUpdate(state, direction, newState, world, pos, posFrom);
    }
